...
PATH = "C:\\Users\\ETG30\\OneDrive\\Desktop\\Python\\osu!\\Songs\\1011011 nekodex - new beginnings\\nekodex - new beginnings (pishifat) [tutorial].osu"

osu = open(PATH,'r+').readlines()
out = {}
sliders = ['C','L','P','B']
